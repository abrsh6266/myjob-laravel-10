                ...
                <form action="{{ route('job.store') }}" method="POST" enctype="multipart/form-data">@csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            <input type="radio" {{$listing->job_type==='Fulltime'?'checked':''}} class="form-check-input" name="job_type" id="Fulltime"
                                value="Fulltime">
                            <label for="Fulltime" class="form-check-label">Fulltime</label>
                        </div>
                        <div class="form-check">
                            <input {{$listing->job_type==='Parttime'?'checked':''}} type="radio" class="form-check-input" name="job_type" id="Parttime"
                                value="Parttime">
                            <label for="Parttime" class="form-check-label">Parttime</label>
                        </div>
                        <div class="form-check">
                            <input {{$listing->job_type==='Casual'?'checked':''}} type="radio" class="form-check-input" name="job_type" id="casual"
                                value="Casual">
                            <label for="casual" class="form-check-label">Casual</label>
                        </div>
                        <div class="form-check">
                            <input {{$listing->job_type==='Contract'?'checked':''}} type="radio" class="form-check-input" name="job_type" id="Contract"
                                value="Contract">
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{$listing->salary}}" type="text" name="salary" id="salary" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{$listing->application_close_date}}" type="text" name="date" id="datepicker" class="form-control">
                        @if ($errors->has('date'))
